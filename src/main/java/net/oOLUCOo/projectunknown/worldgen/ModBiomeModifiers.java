...
public class ModBiomeModifiers {
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_OSMIUM_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                ...
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.OVERWORLD_OSMIUM_ORE_PLACED_KEY)),
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(ProjectUnknown.MODID, name));
    }
}
